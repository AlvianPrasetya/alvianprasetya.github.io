<section id="about" data-speed="2" data-type="background">
	<div class="container">
		<div class="page-header">
			<h1>Contact Me <small>- For All Queries & Related Stuffs</small></h1>
		</div>
		<div class="row-fluid">
			<div class="span4">
			...
			<div class="span4">
				...
				<form class="form">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="inputEmail" placeholder="Insert your email here" style="height: 2em">
						</div>
					</div>
					<div class="control-group">
						<div class="controls">
							* I won't spam you with any unrelated stuffs <br><br>
